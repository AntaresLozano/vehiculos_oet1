...
class Driver {
    ...
    public static function add($data) {
        ...
        $sql = "INSERT INTO drivers (cedula, first_name, second_name, last_name, address, phone, city) 
    ...
    public static function update($id, $data) {
        ...
        $sql = "UPDATE drivers SET cedula = '$cedula', first_name = '$first_name', second_name = '$second_name', 
